...
exports.run = async (client, message, args) => {
 ...
 if(!['716722516701478923', 'EXTRA ROL KOYABİLİRSİN', 'EĞER KOYMAK İSTEMİYORSAN TIRNAKLARI SİL'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
let tag = "𐌞"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '709154288378839150')
